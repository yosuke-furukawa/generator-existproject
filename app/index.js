...
var GeneratorExistProject = yeoman.generators.Base.extend({
  init: function () {
  ...
  askFor: function () {
    ...
    var prompts = [{
      ...
      name: 'projectPath',
      message: 'What\'s the your existing project path?',
      default: "."
    }];
  ...
  templates: function () {
    ...
    console.log(path.resolve(this.projectPath));
    this.directory(path.resolve(this.projectPath), "app/templates");
  },
...
module.exports = GeneratorExistProject;
